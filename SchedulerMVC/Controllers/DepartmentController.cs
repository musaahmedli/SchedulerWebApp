...
using SchedulerMVC.Models.DepartmentModels;
using System;
...
namespace SchedulerMVC.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            departmentViewModel.Authorization = HttpContext.Session.GetString("Auth");
        ...
        {
            List<DepartmentToListDTO> departments =  await _service.GetDepartmentsByOrganization(organizationId);
